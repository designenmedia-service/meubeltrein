              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.company_phone,
                      'is-focused': activeField == 'company_phone'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.contactCompany.fields.company_phone')
                    }}</label>
                    <input
                      class="form-control"
                      type="number"
                      ...
                      @input="updateCompanyPhone"
                      @focus="focusField('company_phone')"
                      @blur="clearFocus"
                    />
                  </div>
                </div>
