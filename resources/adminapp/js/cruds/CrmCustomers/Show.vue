                ...
                <div class="table-responsive">
                  <div class="table">
                    <tbody>
                      ...
                      <tr>
                        <td class="text-primary">
                          {{ $t('cruds.crmCustomer.fields.company_name') }}
                        </td>
                        <td>
                          {{ entry.company_name }}
                        </td>
...
export default {
  ...
  computed: {
    ...mapGetters('CrmCustomersSingle', ['entry'])
  },
  watch: {
    '$route.params.id': {
      immediate: true,
  ...
  methods: {
    ...mapActions('CrmCustomersSingle', ['fetchShowData', 'resetState'])
  }
}
</script>
