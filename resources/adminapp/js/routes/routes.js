    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'nieuw-voertuigs',
            name: 'nieuw_voertuigs.index',
            component: () => import('@cruds/NieuwVoertuigs/Index.vue'),
            meta: { title: 'cruds.nieuwVoertuig.title' }
          },
          {
            path: 'nieuw-voertuigs/create',
            name: 'nieuw_voertuigs.create',
            component: () => import('@cruds/NieuwVoertuigs/Create.vue'),
            meta: { title: 'cruds.nieuwVoertuig.title' }
          },
          {
            path: 'nieuw-voertuigs/:id',
            name: 'nieuw_voertuigs.show',
            component: () => import('@cruds/NieuwVoertuigs/Show.vue'),
            meta: { title: 'cruds.nieuwVoertuig.title' }
          },
          {
            path: 'nieuw-voertuigs/:id/edit',
            name: 'nieuw_voertuigs.edit',
            component: () => import('@cruds/NieuwVoertuigs/Edit.vue'),
            meta: { title: 'cruds.nieuwVoertuig.title' }
          },
          {
